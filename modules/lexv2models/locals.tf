...
locals {
  ...
  # Lambda ARNs keyed by fulfillment_lambda_name. Packages usually pass
  # var.lambda_functions from module.lambda; var.lambda_arns remains supported
  # for callers that only have ARNs. Explicit lambda_arns entries override.
